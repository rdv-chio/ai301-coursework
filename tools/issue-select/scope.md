...
I am proficient in Python, data processing workflows, and standard backend development tools, with working knowledge of Git, Linux/WSL environments, and core software testing. I prefer well-isolated bug fixes, CLI/utility issues, and clear logic or typing errors where expected input/output behaviors are specified. I want to avoid massive frontend framework refactors or complex build system/packaging overhauls.